...
@Component({
  selector: 'app-pelaporan-kewangan',
  templateUrl: './pelaporan-kewangan.component.html',
  styleUrls: ['./pelaporan-kewangan.component.scss']
})
export class PelaporanKewanganComponent implements OnInit, OnDestroy {
  ...
  getChart() {
    ...
    let chart = am4core.create("cd12", am4charts.XYChart);
    ...
    chart.data = [
      ...
      {
        category: "Touchpoints Ucapan Bajet",
        value1: 4,
        value2: 5,
        value3: 6,
        value4: 2
