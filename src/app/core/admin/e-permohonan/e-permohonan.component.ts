import { Component, NgZone, OnInit, OnDestroy, ViewChild, EventEmitter, Output } from '@angular/core';
...
@Component({
  selector: 'app-e-permohonan',
  templateUrl: './e-permohonan.component.html',
  styleUrls: ['./e-permohonan.component.scss'],
  providers: [{ provide: TabsetConfig, useFactory: getTabsetConfig }]
})

export class EPermohonanComponent implements OnInit, OnDestroy {
  ...
  getChart5() {
    ...
    let chartGrantMonitoringTimeline1 = am4core.create("cd91", am4plugins_timeline.SerpentineChart);
  ...
  getChart() {
    ...
    let chart = am4core.create("cd17", am4charts.PieChart3D);
  ...
  getChart1() {
    ...
    let chart = am4core.create("cd27", am4charts.PieChart);
    chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
  ...
  getChart2() {
    ...
    // Create chart
    let chart = am4core.create("cd37", am4charts.PieChart);
    chart.hiddenState.properties.opacity = 0; // this creates initial fade-in

    chart.data = [
      {
        country: "Ucapan bajet negeri",
        value: 260
      },
      {
        country: "KPI Exco",
  ...
  getChart3() {
    ...
    let chart = am4core.create("cd47", am4charts.PieChart3D);
    chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
    ...
    chart.data = [
      ...
      {
        country: "Perlu Pengambilan Semula",
        litres: 99
      }
    ];
  ...
  getChart4() {
    ...
    let chart = am4core.create("cd57", am4charts.XYChart);
